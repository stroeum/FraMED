...
int main()
{
    ...
    if(Var::isNewRun) {
        ...
        */ /* END OF SECTION THAT MANUALLY ASSIGNS USER-DEFINED VALUES */
        ...
        ListDouble alt=IO::read((char*)("atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_z.dat" ));
        IO::print(file, "..: altitude successfully read\n");
        ListDouble ng =IO::read((char*)("atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_ng.dat"));
        IO::print(file, "..: density successfully read\n");
        IO::print(file, "..: Reading ground altitude (z_gnd)\n");
        ...
        CMatrix1D M;
        IO::print(file, "..: Reading grid size (N).\n");
        IO::read(M,(char*)"../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Nxyz.dat");
        Var::N.x = M[0];
        Var::N.y = M[1];
        Var::N.z = M[2];
        IO::print(file, "ii:\t Grid dimensions      : [" + to_string(Var::N.x) + ", " + to_string(Var::N.y) + ", " + to_string(Var::N.z) + "]\n");
        ...
        IO::print(file, "..: Reading grid resolution (d)\n");
        IO::read(M,(char*)"../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Dxyz.dat");
        ...
        */ /* END OF IF ASSIGNING GRID SIZES (EXCLUDING ALTITUDE READ-IN) */
        ...
        IO::read(Var::Ec.initiation,	(char*)("../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_E_initiation_Vm.dat"));
        IO::print(file, "..: initiation threshold successfully read\n");
        IO::read(Var::Ec.positive,		(char*)("../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Eth_positive_Vm.dat"));
        IO::print(file, "..: positive propagation threshold successfully read\n");
        IO::read(Var::Ec.negative,		(char*)("../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Eth_negative_Vm.dat"));
        ...
        if(Var::isVoltageDropped){
            IO::read(Var::Vd.positive,		(char*)("../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Eth_positive_Vm.dat"));
            IO::print(file, "..: positive voltage drop successfully read\n");
            IO::read(Var::Vd.negative,		(char*)("../atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_Eth_negative_Vm.dat"));
        ...
        if(Var::InitiationType == AT_PREDEF_POS){ // Will need to alter values based on desired initiation point:
            Var::InitX	= 6.0e3;													// X-coordinate of initiation point (in meters)
            Var::InitY	= 6.5e3;													// Y-coordinate of initiation point (in meters)
            Var::InitZ	= 4.5e3;                                                    // Z-coordinate of initiation point (in meters)
    ...
    if(Var::isNewRun){
        if (Var::LoadingType == SET_CHARGES) {
            ...
            */
            /* (Negative charge, screening layer) */
            ...
            Var::V.sphere(Var::Vo, Var::Xp,Var::Yp, Var::Zp,Var::Rp1, Var::d,Var::N); 
            
            IO::print(file, "++: Finished setting potential!\n");
        } else if(Var::LoadingType == FROM_FILE) {
            IO::print(file, "..: Loading charge layers\n");
            Var::C.init((char*)"atmos-models/examples/Earth_StreamerBox/streamer-N51-D1mm_rhoAmb.dat",Var::N);
            Var::ChargeCfg.push_back(Var::C);
