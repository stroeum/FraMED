...
/**************************************************************************************/
CriticalFields::CriticalFields(double iinitiation0, double ppositive0, double nnegative0, double zz_gnd, ResGrid _d, SizeGrid _N)
{CriticalFields::init(iinitiation0,ppositive0,nnegative0, zz_gnd, _d,_N);}
						  ...
						  double zz_gnd, ResGrid _d, SizeGrid _N)
{
	...
	{
		initiation[kk] = initiation0*Scaling::StdAtmosphere((kk+kk_gnd)*_d.z);
